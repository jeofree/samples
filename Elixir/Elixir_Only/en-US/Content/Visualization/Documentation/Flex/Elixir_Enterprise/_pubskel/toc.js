...
// **********************************************************  
minus = new Image();
minus.src = "../../../../../_media/doc/minus_default.gif";
plus = new Image();
plus.src = "../../../../../_media/doc/plus_default.gif";
toc_open_img = new Image();
toc_open_img.src = "../../../../../_media/doc/toc_open_default.gif";
toc_closed_img = new Image();
toc_closed_img.src = "../../../../../_media/doc/toc_closed_default.gif";
folder_img = new Image();
folder_img.src = "../../../../../_media/doc/container_obj_default.gif";
topic_img = new Image();
topic_img.src = "../../../../../_media/doc/topic_default.gif";
...
function expandAll() {
	...
	for (i=0; i<alltags.length; i++) {
		if (alltags[i].className =='collapsed') {
			expand(alltags[i]);
		} 
	}
}
...
function collapseAll() {
	...
	var alltags = document.all ? document.all : document.getElementsByTagName("*")
	for (i=0; i<alltags.length; i++) {
		if (alltags[i].className =='expanded') {
			// the root node should never be collapsed
			if (alltags[i].id != 'root' && alltags[i].parentNode.parentNode.id != 'root') {
				collapse(alltags[i]);
			}
		} 
	}
...
function highlightTopic(topic)
{
	if (isMozilla)
  	...
  	if (a != null)
  	{
  	  	//IW - parent.parent.parent.setContentToolbarTitle(tocTitle);
  	  	if (oldActive) 
